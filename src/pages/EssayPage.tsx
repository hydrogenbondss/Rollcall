...
const paragraphs = [
  ...
  `In Hong Kong, where this archive was initiated, the contrast is particularly sharp. The city's public housing estates still stock one-ply recycled paper. Meanwhile, luxury apartments in Mid-Levels offer four-ply imported from Japan, marketed with cherry blossom imagery and "hotel quality" promises. Same city, different plumbing.`,
    ...
    <div className="min-h-screen bg-[#0d0d0d]" ref={pageRef}>
      ...
      <article className="max-w-[720px] mx-auto px-6 sm:px-8 pt-32 pb-20">
        <header className="mb-16">
          ...
          <h1 className="essay-item font-display text-4xl sm:text-5xl text-[#f0ece8] mb-4 leading-[0.95]">
            One-Ply Realism
          </h1>
          <p className="essay-item font-serif-display text-lg text-[#888] italic mb-6">
