    ...
    <div className="min-h-screen bg-[#0d0d0d] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        <div className="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center mx-auto mb-8">
          <Package className="w-10 h-10 text-[#888]" strokeWidth={1.5} />
        </div>
        <p className="font-mono text-[10px] uppercase tracking-[0.4em] text-[#888] mb-4">404</p>
        <h1 className="font-display text-4xl sm:text-5xl text-[#f0ece8] tracking-tight leading-[1.05] mb-4">
          Specimen Not Found
        </h1>
        <p className="font-body text-[15px] text-[#999] leading-relaxed mb-10">
